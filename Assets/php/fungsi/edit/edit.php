...
if (!empty($_SESSION['admin'])) {
    ...
    if(isset($_GET['cari_orders']) && $_GET['cari_orders'] == 'yes'){
        $keyword = $_POST['keyword'];
        $query = $config->prepare("SELECT table_number, customer_name, items_details FROM orders WHERE table_number LIKE ? OR customer_name LIKE ?");
        ...
        if(!empty($result)){
            ...
            foreach($result as $row){
                echo '<tr>
                         ...
                         <td>'.$row['items_details'].'</td>
                         ';
                // Assume items_details is a JSON string, decode it
            ...
            echo '<div class="alert alert-warning" role="alert">Pesanan tidak ditemukan.</div>';
        }
    }
