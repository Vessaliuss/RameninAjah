...
<div class="row">
    ...
    <div class="col-sm-4">
        <div class="card card-primary mb-3">
            <div class="card-header bg-primary text-white">
                <h5><i class="fa fa-search"></i> Cari Pesanan</h5>
            </div>
            <div class="card-body">
                <input type="text" id="cari_orders" class="form-control" name="cari_orders" placeholder="Masukan: Nomor Meja / Nama Customer  [ENTER]">
            </div>
        </div>
    </div>
    <div class="col-sm-8">
        <div class="card card-primary mb-3">
            <div class="card-header bg-primary text-white">
                <h5><i class="fa fa-list"></i> Hasil Pencarian Pesanan</h5>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <div id="hasil_cari_orders"></div>
                    <div id="tunggu_orders"></div>
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function(){
    ...
    $("#cari_orders").change(function(){
        $.ajax({
            type: "POST",
            url: "fungsi/edit/edit.php?cari_orders=yes",
            data:'keyword='+$(this).val(),
            beforeSend: function(){
                $("#hasil_cari_orders").hide();
                $("#tunggu_orders").html('<p style="color:green"><blink>tunggu sebentar</blink></p>');
            },
            success: function(html){
                $("#tunggu_orders").html('');
                $("#hasil_cari_orders").show();
                $("#hasil_cari_orders").html(html);
            }
        });
    });
});
