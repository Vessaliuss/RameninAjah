...
<div class="row">
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-danger text-white">
                <h6 class="pt-2"><i class="fas fa-cubes"></i> Semua Menu</h6>
            </div>
            <div class="card-body">
                <center>
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            ...
            <div class="card-footer">
                <a href='index.php?page=barang'>Tabel
                    Stok Menu <i class='fa fa-angle-double-right'></i></a>
            </div>
        </div>
        <!--/grey-card -->
    </div><!-- /col-md-3-->
    ...
    <div class="col-md-3 mb-3">
        <div class="card">
            <div class="card-header bg-danger text-white">
                <h6 class="pt-2"><i class="fa fa-bookmark"></i> Kategori Menu</h6>
            </div>
            <div class="card-body">
                <center>
            ...
            <div class="card-footer">
                <a href='index.php?page=kategori'>Tabel
                    Kategori Menu <i class='fa fa-angle-double-right'></i></a>
            </div>
        </div>
        <!--/grey-card -->
    </div><!-- /col-md-3-->
